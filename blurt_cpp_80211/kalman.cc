...
KalmanPilotTracker::KalmanPilotTracker(float uncertainty, float var_n) {
    ...
    const float sigma_noise = 4*var_n*.5f;
    const float sin_std_theta = sinf(std_theta);
...
template <class T>
inline void dot(const std::vector<T> &a, const std::vector<T> &b, std::vector<T> &c, size_t n, size_t m, size_t l) {
...
template <class T>
inline void trans(const std::vector<T> &a, std::vector<T> &b, size_t n, size_t m) {
...
template <class T>
void solve(const std::vector<T> &a, const std::vector<T> &b, std::vector<T> &x, size_t n, size_t m, size_t l) {
    // solve a x = b for x
